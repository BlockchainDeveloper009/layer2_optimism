...
contract Initializer_Test is Bridge_Initializer {
    ...
    function test_cannotReinitialize_succeeds() public {
        // Get names of all contracts in the src directory.
        ...
        // TODO: Actually include these contracts once we fix the deployment script.
        ...
        for (uint256 i; i < contractNames.length; i++) {
            ...
            // implementations inside of the deploy script. We should add support for this in the
            // future so that we can properly check that the implementations for predeployed
            // contracts are initialized too.
